...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        start_time: [{ required: true, message: '选择开始日期时间', trigger: 'blur' }],
        end_time: [{ required: true, message: '选择结束日期时间', trigger: 'blur' }],
  ...
  methods: {
    ...
    resetTemp() {
      ...
      this.temp = {
        id: 0,
        start_time: formatYMDHMS(new Date()),
        end_time: formatYMDHMS(endDate),
        content: undefined,
